  ...
  database.ref("providers").orderByChild("businessName").equalTo(user).once("value", function(snapshot){
      ...
      snapshot.forEach(function(childSnapshot){
          ...
          $("#providerFirstName").val(childSnapshot.child("firstname").val());
          $("#providerLastName").val(childSnapshot.child("lastname").val());
          $("#businessName").val(childSnapshot.child("businessName").val());
          ...
          $("#providerPhoneNumber").val(childSnapshot.child("phone").val());
         
          $("#miles").val(childSnapshot.child("miles").val());
